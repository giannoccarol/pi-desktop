...
(function exposeStore(root) {
  ...
  const el = {
    ...
    btnMobileCopy: $("#btn-mobile-copy"),
    btnMobileToken: $("#btn-mobile-token"),
    ...
    bulkCancelBtn: $("#btn-bulk-cancel"),
    rightPanel: $("#right-panel"),
    rightExplorerPane: $("#right-explorer-pane"),
    rightChangesPane: $("#right-changes-pane"),
    rightClose: $("#btn-right-close"),
    rightResizer: $("#right-resizer"),
    changesList: $("#changes-list"),
    changesDetail: $("#changes-detail"),
    changesBadge: $("#changes-badge"),
    changesBadgeInner: $("#changes-badge-inner"),
    changesToggle: null,
    explorerPanel: $("#explorer-panel"),
    explorerList: $("#explorer-list"),
    explorerClose: $("#btn-right-close"),
    explorerToggle: $("#btn-explorer"),
    terminalPanel: $("#terminal-panel"),
    terminalInput: $("#terminal-input"),
    terminalOutput: $("#terminal-output"),
    terminalClose: $("#btn-terminal-close"),
    terminalToggle: $("#btn-terminal"),
    healthBanner: $("#health-banner"),
    healthLogBtn: $("#btn-health-log"),
    btnWinMinimize: $("#btn-win-minimize"),
    btnWinMaximize: $("#btn-win-maximize"),
    btnWinClose: $("#btn-win-close"),
