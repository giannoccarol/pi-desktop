...
globalThis.piUtils = require("../src/renderer/utils.js");
globalThis.piMessageView = require("../src/renderer/message-view.js");
...
test("decomposition: auth.js exposes expected API and is require-able in Node", () => {
  const auth = require("../src/renderer/auth.js");
...
test("decomposition: extension-bridge.js exposes expected API", () => {
  const ext = require("../src/renderer/extension-bridge.js");
...
test("decomposition: media.js exposes expected API and safeImageSource logic", () => {
  const media = require("../src/renderer/media.js");
...
test("decomposition: bootstrap.js exposes wireUi and boot", () => {
  const boot = require("../src/renderer/bootstrap.js");
  assert.equal(typeof boot.wireUi, "function");
  assert.equal(typeof boot.boot, "function");
  const content = fs.readFileSync(path.join(root, "src/renderer/bootstrap.js"), "utf8");
...
test("decomposition: runtime-events.js exposes both factories", () => {
  const rt = require("../src/renderer/runtime-events.js");
